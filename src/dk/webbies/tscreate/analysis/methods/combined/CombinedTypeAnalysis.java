...
public class CombinedTypeAnalysis implements TypeAnalysis {
    ...
    public CombinedTypeAnalysis(HashMap<Snap.Obj, LibraryClass> libraryClasses, Options options, Snap.Obj globalObject, DeclarationParser.NativeClassesMap nativeClasses) {
        mixed = new MixedTypeAnalysis(libraryClasses, options, globalObject, nativeClasses);
