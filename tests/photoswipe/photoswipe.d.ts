...
declare module PhotoSwipeModule {
    /**
 ...
 */
declare class PhotoSwipe<T extends PhotoSwipeModule.Options> {
    /**
    ...
    constructor(pswpElement: HTMLElement,
                uiConstructor: (new (pswp: PhotoSwipe<T>, framework: PhotoSwipeModule.UIFramework) => PhotoSwipeModule.UI<T>) | boolean,
                items: PhotoSwipeModule.Item[],
                options: T);

    /**
     * Current slide object.
     */
    currItem: PhotoSwipeModule.Item;
     ...
     */
    framework: PhotoSwipeModule.UIFramework;

    /**
     * The ui instance constructed by PhotoSwipe.
     */
    ui: PhotoSwipeModule.UI<T>;
     ...
     */
    listen(eventName: 'imageLoadComplete', callback: (index: number, item: PhotoSwipeModule.Item) => void): void;
    /**
     ...
     */
    listen(eventName: 'gettingData', callback: (index: number, item: PhotoSwipeModule.Item) => void): void;
    /**
     ...
     * });
     */
    listen(eventName: 'parseVerticalMargin', callback: (item: PhotoSwipeModule.Item) => void): void;
    /**
 ...
 */
declare class PhotoSwipeUI_Default implements PhotoSwipeModule.UI<PhotoSwipeUI_Default_Module.Options> {
    constructor(pswp: PhotoSwipe<PhotoSwipeUI_Default_Module.Options>, framework: PhotoSwipeModule.UIFramework);
    init(): void;
...
declare module PhotoSwipeUI_Default_Module {
     ...
     */
    interface Item extends PhotoSwipeModule.Item {
        /**
