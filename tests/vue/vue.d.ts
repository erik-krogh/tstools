...
declare module vuejs {
    ...
    interface Vue {
        ...
        $appendTo(target: (HTMLElement | string), callback?: Function, withTransition?: boolean): Vue;
        $prependTo(target: (HTMLElement | string), callback?: Function, withTransition?: boolean): Vue;
        $before(target: (HTMLElement | string), callback?: Function, withTransition?: boolean): Vue;
        $after(target: (HTMLElement | string), callback?: Function, withTransition?: boolean): Vue;
        ...
        $mount(elementOrSelector?: (HTMLElement | string)): Vue;
    ...
    interface VueUtil {
        ...
        // util/options.js
        mergeOptions<P, C>(parent: P, child: C, vm?: any): any;
